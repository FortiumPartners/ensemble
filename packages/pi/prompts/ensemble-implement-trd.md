...
<!-- Command: ensemble:implement-trd | Version: 2.3.0 -->
...
6. Execute - git town hack feature/<trd-slug>-sprint-1 (creates the first sprint branch off the default branch; fallback - git switch -c feature/<trd-slug>-sprint-1)
