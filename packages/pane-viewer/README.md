...
```bash
claude plugin install @fortium/ai-mesh-pane-viewer
```

## Description

Part of the ai-mesh plugin ecosystem for Claude Code. This plugin provides real-time subagent monitoring in terminal panes.
