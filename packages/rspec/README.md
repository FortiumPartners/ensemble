...
```bash
claude plugin install @fortium/ai-mesh-rspec
```

## Description

Part of the ai-mesh plugin ecosystem for Claude Code. This plugin provides rspec testing framework integration.
