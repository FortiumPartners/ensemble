...
This document catalogs all components from the AI-Mesh monorepo (`/Users/ldangelo/Development/Fortium/ai-mesh/`) for reorganization into focused NPM plugins.
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/ai-mesh-orchestrator.yaml`
- **Size**: ~15 KB
- **Version**: 2.3.0
...
- **Target Plugin**: `@ai-mesh/agent-mesh-orchestrators`
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/tech-lead-orchestrator.yaml`
- **Size**: ~12 KB
- **Version**: Latest
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/product-management-orchestrator.yaml`
- **Size**: ~10 KB
...
#### qa-orchestrator
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/qa-orchestrator.yaml`
- **Size**: ~10 KB
...
#### build-orchestrator
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/build-orchestrator.yaml`
- **Size**: ~9 KB
- **Tools**: Read, Write, Bash
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/infrastructure-orchestrator.yaml`
- **Size**: ~10 KB
- **Tools**: Read, Write, Bash
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/deployment-orchestrator.yaml`
- **Size**: ~9 KB
- **Tools**: Read, Write, Bash
...
#### backend-developer
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/backend-developer.yaml`
- **Size**: ~8 KB
- **Version**: 2.1.0
...
- **Target Plugin**: `@ai-mesh/agent-mesh-specialists`
- **Description**: Server-side implementation with framework skill integration

#### frontend-developer
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/frontend-developer.yaml`
- **Size**: ~10 KB
- **Version**: 2.1.0
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/infrastructure-developer.yaml`
- **Size**: ~28 KB
- **Version**: 2.2.0
- **Tools**: Read, Write, Edit, Grep, Glob, Bash, Task
...
#### code-reviewer
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/code-reviewer.yaml`
- **Size**: ~10 KB
...
#### test-runner
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/test-runner.yaml`
- **Size**: ~8 KB
- **Tools**: Read, Bash
...
#### playwright-tester
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/playwright-tester.yaml`
- **Size**: ~9 KB
...
#### test-reader-agent
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/test-reader-agent.yaml`
- **Size**: ~6 KB
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/documentation-specialist.yaml`
- **Size**: ~12 KB
- **Tools**: Read, Write, Edit
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/agent-mesh-specialists`
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/api-documentation-specialist.yaml`
- **Size**: ~8 KB
- **Tools**: Read, Write, Edit
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/postgresql-specialist.yaml`
- **Size**: ~8 KB
- **Tools**: Read, Write, Bash
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/agent-mesh-specialists`
...
#### git-workflow
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/git-workflow.yaml`
- **Size**: ~8 KB
- **Tools**: Bash
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/agent-mesh-specialists`
...
#### github-specialist
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/github-specialist.yaml`
- **Size**: ~7 KB
- **Tools**: Bash
...
#### file-creator
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/file-creator.yaml`
- **Size**: ~6 KB
- **Tools**: Write
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/agent-mesh-specialists`
...
#### directory-monitor
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/directory-monitor.yaml`
- **Size**: ~7 KB
- **Tools**: Read, Bash
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/agent-mesh-specialists`
...
#### release-agent
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/release-agent.yaml`
- **Size**: ~8 KB
- **Tools**: Read, Write, Bash
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/manager-dashboard-agent.yaml`
- **Size**: ~9 KB
- **Tools**: Read, Bash
...
#### agent-meta-engineer
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/agent-meta-engineer.yaml`
- **Size**: ~10 KB
- **Tools**: Read, Write, Edit
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/agent-mesh-core`
- **Description**: Agent ecosystem management, agent creation

#### general-purpose
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/general-purpose.yaml`
- **Size**: ~6 KB
- **Tools**: Read, Write, Edit, Bash, Grep, Glob
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/agent-mesh-core`
...
#### context-fetcher
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/context-fetcher.yaml`
- **Size**: ~7 KB
...
#### deep-debugger
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/deep-debugger.yaml`
- **Size**: ~8 KB
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/agents/yaml/helm-chart-specialist.yaml`
- **Size**: ~7 KB
...
#### create-trd
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/create-trd.yaml`
- **Size**: ~12 KB
- **Version**: 1.0.0
- **Agents Invoked**: ai-mesh-orchestrator → tech-lead-orchestrator
- **MCP Integration**: TRD Workflow MCP (optional)
- **Output**: @docs/TRD/{project-name}-trd.md
- **Target Plugin**: `@ai-mesh/command-trd-workflow`
- **Description**: PRD to TRD conversion with task breakdown

#### implement-trd
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/implement-trd.yaml`
- **Size**: ~8 KB
- **Version**: 1.0.0
- **Agents Invoked**: ai-mesh-orchestrator → tech-lead-orchestrator → specialists
- **Git Integration**: git-town feature branch workflow
- **Target Plugin**: `@ai-mesh/command-trd-workflow`
- **Description**: Complete TRD implementation with TDD methodology

#### refine-trd
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/refine-trd.yaml`
- **Size**: ~6 KB
...
#### create-prd
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/create-prd.yaml`
- **Size**: ~10 KB
- **Agents Invoked**: product-management-orchestrator
- **Output**: @docs/PRD/{product-name}.md
- **Target Plugin**: `@ai-mesh/command-core`
- **Description**: Product Requirements Document creation

#### refine-prd
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/refine-prd.yaml`
- **Size**: ~6 KB
- **Agents Invoked**: product-management-orchestrator
- **Target Plugin**: `@ai-mesh/command-core`
...
#### analyze-product
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/analyze-product.yaml`
- **Size**: ~8 KB
- **Agents Invoked**: product-management-orchestrator
- **Target Plugin**: `@ai-mesh/command-core`
...
#### playwright-test
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/playwright-test.yaml`
- **Size**: ~7 KB
...
#### generate-api-docs
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/generate-api-docs.yaml`
- **Size**: ~6 KB
...
#### release
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/release.yaml`
- **Size**: ~8 KB
...
#### claude-changelog
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/claude-changelog.yaml`
- **Size**: ~6 KB
...
#### sprint-status
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/sprint-status.yaml`
- **Size**: ~6 KB
- **Agents Invoked**: tech-lead-orchestrator
- **Target Plugin**: `@ai-mesh/command-core`
...
#### manager-dashboard
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/manager-dashboard.yaml`
- **Size**: ~7 KB
...
#### fold-prompt
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/fold-prompt.yaml`
- **Size**: ~8 KB
- **Agents Invoked**: ai-mesh-orchestrator
- **Target Plugin**: `@ai-mesh/command-core`
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/commands/yaml/web-metrics-dashboard.yaml`
- **Size**: ~6 KB
- **Agents Invoked**: manager-dashboard-agent
- **Target Plugin**: `@ai-mesh/command-core`
...
#### rails-framework
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/rails-framework/`
- **Files**: 17 files
...
#### dotnet-framework
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/dotnet-framework/`
- **Files**: 17 files
...
#### react-framework
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/react-framework/`
- **Files**: 15 files
...
#### blazor-framework
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/blazor-framework/`
- **Files**: 16 files
...
#### kubernetes
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/kubernetes/`
- **Files**: 2 files
...
#### flyio
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/flyio/`
- **Files**: 70 files
...
#### jest-test
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/jest-test/`
- **Files**: 6 files
- **Contents**: SKILL.md, generate-test.js, run-test.js, templates/
- **Target Plugin**: `@ai-mesh/skills-testing`
- **Description**: Jest unit/integration testing for JavaScript/TypeScript

#### rspec-test
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/rspec-test/`
- **Files**: 3 files
- **Contents**: SKILL.md
- **Target Plugin**: `@ai-mesh/skills-testing`
...
#### pytest-test
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/pytest-test/`
- **Files**: 3 files
- **Contents**: SKILL.md
- **Target Plugin**: `@ai-mesh/skills-testing`
...
#### exunit-test
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/exunit-test/`
- **Files**: 3 files
- **Contents**: SKILL.md
- **Target Plugin**: `@ai-mesh/skills-testing`
...
#### xunit-test
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/xunit-test/`
- **Files**: 3 files
- **Contents**: SKILL.md
- **Target Plugin**: `@ai-mesh/skills-testing`
...
#### test-detector
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/test-detector/`
- **Files**: 3 files
...
#### smoke-test-runner
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/smoke-test-runner/`
- **Files**: 3 files
...
#### smoke-test-api
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/smoke-test-api/`
- **Files**: 4 files
- **Contents**: SKILL.md, REFERENCE.md
- **Target Plugin**: `@ai-mesh/skills-testing`
...
#### smoke-test-auth
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/smoke-test-auth/`
- **Files**: 3 files
...
#### smoke-test-database
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/smoke-test-database/`
- **Files**: 4 files
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/smoke-test-external-services/`
- **Files**: 3 files
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/smoke-test-critical-paths/`
- **Files**: 3 files
...
#### framework-detector
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/framework-detector/`
- **Files**: 5 files
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/cloud-provider-detector/`
- **Files**: 4 files
...
#### tooling-detector
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/tooling-detector/`
- **Files**: 4 files
...
#### changelog-generator
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/skills/changelog-generator/`
- **Files**: 4 files
- **Contents**: SKILL.md, REFERENCE.md
- **Target Plugin**: `@ai-mesh/skills-core`
...
#### session-start.js
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/session-start.js`
- **Size**: ~10 KB
- **Event**: Session initialization
- **Dependencies**: user-profile.js, metrics-api-client.js
- **Target Plugin**: `@ai-mesh/hooks-lifecycle`
- **Description**: Initialize user session, load profile, start metrics tracking

#### session-end.js
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/session-end.js`
- **Size**: ~20 KB
...
#### tool-metrics.js
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/tool-metrics.js`
- **Size**: ~28 KB
- **Event**: Tool execution (Read, Write, Edit, Bash, etc.)
- **Dependencies**: user-profile.js, metrics-api-client.js
- **Target Plugin**: `@ai-mesh/hooks-metrics`
- **Description**: Track tool performance, send to Real-Time Activity Feed

#### analytics-engine.js
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/analytics-engine.js`
- **Size**: ~23 KB
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/metrics-api-client.js`
- **Size**: ~12 KB
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/hooks-metrics`
...
#### user-profile.js
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/user-profile.js`
- **Size**: ~9 KB
- **Dependencies**: None
- **Target Plugin**: `@ai-mesh/hooks-lifecycle`
...
#### get-auth-token.js
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/get-auth-token.js`
- **Size**: ~2 KB
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/test-session-consistency.js`
- **Size**: ~4 KB
- **Dependencies**: session-start.js, session-end.js
- **Target Plugin**: `@ai-mesh/hooks-metrics` (test utilities)
- **Description**: Validate session ID consistency across hooks

#### performance-test.js
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/performance-test.js`
- **Size**: ~16 KB
...
- **Path**: `/Users/ldangelo/Development/Fortium/ai-mesh/hooks/migrate-python-to-nodejs.js`
- **Size**: ~16 KB
- **Dependencies**: None
...
|-------|---------------------|-----------------|
| ai-mesh-orchestrator | create-trd, implement-trd, fold-prompt | Primary orchestrator |
...
| infrastructure-orchestrator | (via ai-mesh-orchestrator) | Environment management |
...
#### @ai-mesh/agent-mesh-core
- **Components**: 3 agents
- **Agents**: agent-meta-engineer, general-purpose, context-fetcher
- **Size**: ~23 KB
- **Purpose**: Foundational agent mesh infrastructure

#### @ai-mesh/agent-mesh-orchestrators
- **Components**: 7 agents
- **Agents**: ai-mesh-orchestrator, tech-lead-orchestrator, product-management-orchestrator, qa-orchestrator, build-orchestrator, infrastructure-orchestrator, deployment-orchestrator
- **Size**: ~75 KB
- **Purpose**: Strategic orchestration layer

#### @ai-mesh/agent-mesh-specialists
...
|----------|--------|------------|------------|--------------|------|
| P0 | @ai-mesh/agent-mesh-core | 3 agents | Low | None | Low |
| P0 | @ai-mesh/command-core | 11 commands | Medium | Orchestrators | Medium |
| P1 | @ai-mesh/agent-mesh-orchestrators | 7 agents | High | Core, Specialists | High |
| P1 | @ai-mesh/agent-mesh-specialists | 17 agents | High | Skills, Hooks | High |
| P2 | @ai-mesh/command-trd-workflow | 3 commands | Medium | Orchestrators | Medium |
| P2 | @ai-mesh/skills-frameworks | 7 skills | Medium | Detectors | Medium |
| P2 | @ai-mesh/skills-infrastructure | 5 skills | Medium | Detectors | Medium |
| P2 | @ai-mesh/skills-testing | 12 skills | Low | None | Low |
| P3 | @ai-mesh/hooks-lifecycle | 4 hooks | Low | User Profile | Low |
| P3 | @ai-mesh/hooks-metrics | 5 hooks | Medium | API Client | Medium |
...
```
@ai-mesh/agent-mesh-core:           ~23 KB   |   1.6%
@ai-mesh/agent-mesh-orchestrators:  ~75 KB   |   5.4%
@ai-mesh/agent-mesh-specialists:   ~140 KB   |  10.0%
@ai-mesh/command-core:              ~78 KB   |   5.6%
@ai-mesh/command-trd-workflow:      ~26 KB   |   1.9%
@ai-mesh/skills-frameworks:        ~400 KB   |  28.6%
@ai-mesh/skills-infrastructure:    ~350 KB   |  25.0%
@ai-mesh/skills-testing:           ~150 KB   |  10.7%
@ai-mesh/hooks-lifecycle:           ~41 KB   |   2.9%
@ai-mesh/hooks-metrics:             ~83 KB   |   5.9%
─────────────────────────────────────────────────
Total:                            ~1.37 MB   | 100.0%
```
...
2. **Commands → Agents**
   - All commands → ai-mesh-orchestrator (primary routing)
...
4. **Shared Types**: Create `@ai-mesh/types` for shared TypeScript interfaces

### Migration Phases

**Phase 1: Foundation (P0)**
- Extract @ai-mesh/agent-mesh-core
- Extract @ai-mesh/command-core
- Establish plugin architecture patterns

**Phase 2: Orchestration (P1)**
- Extract @ai-mesh/agent-mesh-orchestrators
- Extract @ai-mesh/agent-mesh-specialists
- Validate delegation workflows

**Phase 3: Specialization (P2)**
- Extract all skills packages
- Extract @ai-mesh/command-trd-workflow
